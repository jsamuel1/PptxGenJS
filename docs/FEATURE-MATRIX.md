...
| ❌ Missing | comments, talking-points notes export, embedded fonts, SmartArt, motion animations, handout master, ink |
...
5. **Then everything else** — comments, talking-points notes export, embedded fonts, SmartArt, handout master, hover links, **ink** (niche but tractable).
