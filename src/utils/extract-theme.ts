...
const COLOR_SLOTS = new Set<keyof ThemePalette>(['bg', 'bgSecondary', 'accent', 'accentSoft', 'text', 'textSecondary', 'sky', 'green', 'orange', 'red'])
...
export function extractThemeFromCSS (css: string, options: ExtractThemeOptions = {}): ThemePalette {
	...
	const theme: ThemePalette = { ...DARK_PRESET, ...base }
